...
2. Clone the repo
   ```sh
   git clone https://github.com/dy-chi/ml_unsupervised_project.git
   ```
...
See the [open issues](https://github.com/dy-chi/ml_unsupervised_project/issues) for a full list of proposed features (and known issues).
